...
def quiz_view():
    ...
    if player == None:
        # return 'Please <a href="/login">Login again</a>'
        return 'NOLOGIN'
    else:
    ...
    if r_num == 0: # Quiz not started
        return render_template('quiz_not_started.html', players=players)
    ...
    if state['done'] == 0: # Active round
        ...
        return render_template('quiz_round.html', players=players, r_num=r_num, questions=questions, answers=answers, enumerate=enumerate)
        ...
        return render_template('quiz_round_done.html', players=players, r_num=r_num, questions=questions, responses=org_responses, enumerate=enumerate)
